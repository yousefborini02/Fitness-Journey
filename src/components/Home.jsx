...
const Home = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[url('https://fetchpik.com/images/fetchpik.com-dCKeL0acmX.jpg')] bg-cover bg-no-repeat bg-center p-5 relative">
